...
export function GameDetails({ className }: GameDetailsProps) {
  ...
  return (
    <>
      <header className="bg-[#1e1e2e] shadow-lg sticky top-0 z-40 w-full overflow-x-hidden">
        <div className="flex items-center justify-between min-h-[4rem] px-2 sm:px-4 min-w-0 w-full py-2">
            ...
            {isVisible ? (
              <div className="flex items-center gap-2 sm:gap-4 lg:gap-6 min-w-0 flex-shrink flex-1">
                ...
                {config.coverImageUrl && (
                  <div className="flex-shrink-0 hidden sm:block">
                    <img
                      ...
                      alt={config.title}
                      className="w-12 h-16 sm:w-16 sm:h-20 object-cover rounded-none border border-ctp-surface1"
                    />
                  </div>
                )}
                ...
                <div className="flex-1 min-w-0">
                  {/* Title */}
                  <div className="mb-1">
                    <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-ctp-text truncate">
                      {config.title}
                      {config.subtitle && (
