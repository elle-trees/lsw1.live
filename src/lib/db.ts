...
import {
  getGameDetailsFirestore,
  updateGameDetailsFirestore
} from "./data/firestore/gameDetails";
...
export const getGameDetails = getGameDetailsFirestore;
export const updateGameDetails = updateGameDetailsFirestore;
